...
var x__28672__auto__ = (((x == null))?null:x);
var m__28673__auto__ = (sablono.util.to_str[goog.typeOf(x__28672__auto__)]);
if(!((m__28673__auto__ == null))){
return m__28673__auto__.call(null,x);
} else {
var m__28673__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__28673__auto____$1 == null))){
return m__28673__auto____$1.call(null,x);
} else {
...
var x__28672__auto__ = (((x == null))?null:x);
var m__28673__auto__ = (sablono.util.to_uri[goog.typeOf(x__28672__auto__)]);
if(!((m__28673__auto__ == null))){
return m__28673__auto__.call(null,x);
} else {
var m__28673__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__28673__auto____$1 == null))){
return m__28673__auto____$1.call(null,x);
} else {
...
var len__29158__auto___30018 = arguments.length;
var i__29159__auto___30019 = (0);
while(true){
if((i__29159__auto___30019 < len__29158__auto___30018)){
args__29165__auto__.push((arguments[i__29159__auto___30019]));

var G__30020 = (i__29159__auto___30019 + (1));
i__29159__auto___30019 = G__30020;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__29166__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq30017){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30017));
});
...
var vec__30021 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__30023;
var words = seq__30022__$1;
...
var G__30024 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__30024,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__30024;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__30025_SHARP_){
if(typeof p1__30025_SHARP_ === 'string'){
return p1__30025_SHARP_;
} else {
return cljs.core.seq.call(null,p1__30025_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__27989__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1521204770910
