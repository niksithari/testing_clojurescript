...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__30028_SHARP_){
return ((p1__30028_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__30028_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__30029,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__30029;
}
});
...
var len__29158__auto___30032 = arguments.length;
var i__29159__auto___30033 = (0);
while(true){
if((i__29159__auto___30033 < len__29158__auto___30032)){
args__29165__auto__.push((arguments[i__29159__auto___30033]));

var G__30034 = (i__29159__auto___30033 + (1));
i__29159__auto___30033 = G__30034;
continue;
} else {
}
break;
...
var G__30031 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__30031,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__30031;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq30030){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30030));
});
...
var vec__30037 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__30037,(0),null);
var names = cljs.core.nth.call(null,vec__30037,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__30037,tag_name,names){
return (function (p1__30035_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__30035_SHARP_));
});})(matches,vec__30037,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__30037,tag_name,names){
return (function (p1__30036_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__30036_SHARP_));
});})(matches,vec__30037,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__30040){
...
var tag = first__30043;
var content = seq__30042__$1;
...
var vec__30044 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__30044,(0),null);
var id = cljs.core.nth.call(null,vec__30044,(1),null);
var class$ = cljs.core.nth.call(null,vec__30044,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1521204771060
