...
var or__27989__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34781 = {"detail":data};
return obj34781;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27977__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27977__auto__)){
var and__27977__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__34788 = cljs.core._EQ_;
var expr__34789 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34788.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34789))){
return ((function (pred__34788,expr__34789){
return (function (p1__34782_SHARP_){
return console.warn(p1__34782_SHARP_);
});
;})(pred__34788,expr__34789))
} else {
if(cljs.core.truth_(pred__34788.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34789))){
return ((function (pred__34788,expr__34789){
return (function (p1__34783_SHARP_){
return console.debug(p1__34783_SHARP_);
});
;})(pred__34788,expr__34789))
} else {
if(cljs.core.truth_(pred__34788.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34789))){
return ((function (pred__34788,expr__34789){
return (function (p1__34784_SHARP_){
return console.error(p1__34784_SHARP_);
});
;})(pred__34788,expr__34789))
} else {
return ((function (pred__34788,expr__34789){
return (function (p1__34785_SHARP_){
return console.log(p1__34785_SHARP_);
});
;})(pred__34788,expr__34789))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34792){
var map__34793 = p__34792;
var map__34793__$1 = ((((!((map__34793 == null)))?((((map__34793.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34793.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34793):map__34793);
var opts = map__34793__$1;
var eval_fn = cljs.core.get.call(null,map__34793__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34795_SHARP_);
});})(new_def))
);
...
return (function (p__34796){
var vec__34797 = p__34796;
var ky = cljs.core.nth.call(null,vec__34797,(0),null);
var v = cljs.core.nth.call(null,vec__34797,(1),null);
...
if(cljs.core.truth_((function (){var and__27977__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1521204777614
